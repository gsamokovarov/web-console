(function() {
  ...
  // Configurable mixin.
  //
  // When mixed into the prototype, it adds a #configure method accepting an
  // options object. Each time the method is invoked it merges the options with
  // the previous.
  WebConsole.Configurable = {
  ...
  $.extend(WebConsole.Cursor.prototype, Configurable);
  ...
  // Control Sequence Introducer utilities.
  //
  // This class is responsible for parsing the CSI codes.
  WebConsole.CSI = function(options) {
    this.configure(options);
  };
